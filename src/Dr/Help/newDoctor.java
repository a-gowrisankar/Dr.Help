...
public class newDoctor {
	...
	private void submitButton() 
	{
		...
		try
		{
			Models.InsertInToDB.insertNewDoctor(tName.getText(),tPass.getText(),getDOB(),
					(String)gender.getSelectedItem(),tEmail.getText(),
					tPhone.getText(),(catDisp.getSelectedIndex()+1),tHospital.getText());
